...
SET status = 'active',
    version = '0.11.0',
    description = 'OpenAI Realtime streaming, Google and ElevenLabs voice agents with disclosure, private bounded sessions and human handoff.',
    updated_at = now()
WHERE module_key = 'ai-receptionist';

INSERT INTO schema_migrations(version)
VALUES ('013_openai_realtime')
